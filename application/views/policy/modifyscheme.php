    ...
    <div class="page-content">
        ...
        foreach ($content as $row) {# code...
            if($count%3 == 1){
                ...
                echo '<br>
																		<a href="'.base_url().'policy/modify/'.$row->scheme_id.'" class="label label-warning">Edit This Scheme</a>
																	</div>
																</div>
															</div>
														</div>
                ...
                echo $row->scheme_objectives;
                echo '<br>
																<a href="'.base_url().'policy/modify/'.$row->scheme_id.'" class="label label-danger">Edit This Scheme</a>
															</div>
														</div>
													</div>
												</div>
