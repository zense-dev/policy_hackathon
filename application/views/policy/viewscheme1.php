...
<div id="sidebar" class="sidebar                  responsive">
    ...
    <div class="sidebar-shortcuts" id="sidebar-shortcuts">
        ...
        <br><br><br>
        <li>Yello color - Verified by Users</li>
        <li>Green Color - Verified By Govt</li>
...
<div class="main-content">
    ...
    <div class="page-content">
        <button onclick="load_gender()">Schemes For Women</button>
        <button onclick="load_area()">Rural</button>
        <button onclick="load_marital()">Married</button>
        <hr>
        <!-- PAGE CONTENT BEGINS -->
        <div id="populate">
        ...
        <hr>
        <button class="btn-lg btn-danger">Export as PDF</button>
        <div class="row">
            <div class="col-xs-12">
...
<script>
    var policy_url = '<?php base_url()."policy/viewpage/"?>';
    var json_array = '';
    $.ajax({
        type    : 'POST',
        url     : '<?php echo base_url()."policy/schemes_json"?>',
        dataType : 'json',
        encode: true
    })
        ...
        .done(function(data){
            ...
            $.each(data, function(index, value){
                if(value.gender==1){
                    $('#populate').append('<li>'+value.scheme_name+'</li>')
                }
    ...
    var load_gender= function(){
        ...
        $.each(json_array, function(index, value){
            if(value.gender==1 || value.gender==2){
                ...
                output+='<div class="col-sm-4 widget-container-col" style="padding-bottom:10px;"><!--Box Starts Here-->\
                    <div class="widget-box widget-color-dark">\
                    <div class="widget-header widget-hea1der-small">\
                    <h6 class="widget-title">'
                    +value.scheme_name+'</h6>\
                    </div>\
                    ...
                    '+value.scheme_objectives+
                    '<br><a href="'+policy_url+value.scheme_id+'"class="label label-success">Read More</a>'+
                    '<br>\
                </div>\
                </div>\
                </div>\
        ...
        $('#populate').append(output);
    }

    var load_marital= function(){
        $('#populate').html('')
        $.each(json_array, function(index, value){
