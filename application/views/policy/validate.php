            ...
            <div class="col-xs-10">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <ol>
                                <li><dt>Area</dt><p>Rural/Urban/All</p></li>
                                <li><dt>Gender</dt><p>Male/Female/All</p></li>
                                <li><dt>Marital Status</dt><p>XYZ</p></li>
                                <li><dt>Income Range</dt><p>BPL/APL</p></li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xs-10">
                <p>
                    ...
                    <button class="btn btn-success">Export data to CSV</button>
                </p>
            </div>
        </div>
