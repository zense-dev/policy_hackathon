        ...
        <div class="navbar-header pull-left">
            <a href="#" class="navbar-brand">
                <small>
                    ...
                    Zense - Connect the disconnected
                </small>
            </a>
        </div>
...
<!-- /.sidebar-shortcuts -->
    ...
    <?php include 'navbar.php'?><!-- /.nav-list -->
...
<div class="step-pane active" id="step1">
    ...
    <div class="form-group has-info">
        ...
        <div class="col-xs-12 col-sm-5">
														<span class="block input-icon input-icon-right">
															<input type="text" id="inputInfo" class="width-100" name="scheme_name" value="<?php echo $scheme[0]->scheme_name ?>"/>
														</span>
        </div>
    </div><br><br><br>
    ...
    <input type="hidden" name="scheme_id" value="<?php echo $scheme[0]->scheme_id?>"/>
    <div class="form-group has-info row">
        ...
        <div class="col-xs-12 col-sm-5">
            <textarea class="form-control" id="form-field-8" placeholder="Default Text" name="scheme_objective""><?php echo $scheme[0]->scheme_objectives?></textarea>
        </div>
    </div>
    <div class="form-group has-info row">
        <label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right" >Registration Procedure</label>
        <div class="col-xs-12 col-sm-5">
            <textarea class="form-control" id="form-field-8" name="scheme_reginfo"><?php echo $scheme[0]->scheme_reginfo?></textarea>
        </div>
    </div>
    <div class="form-group has-info row">
        <label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right" >Documents Needed</label>
        <div class="col-xs-12 col-sm-5">
            <textarea class="form-control" id="form-field-8" name="scheme_documents"><?php echo $scheme[0]->scheme_documents?></textarea>
        </div>
    </div>
    <div class="form-group has-info row">
        <label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right" >Scheme Benefits</label>
        <div class="col-xs-12 col-sm-5">
            <textarea class="form-control" id="form-field-8" placeholder="Default Text" name="scheme_benefits"><?php echo $scheme[0]->scheme_benefits?></textarea>
        </div>
    </div>
</div>
...
<div class="step-pane" id="step2">
    <div class="col-xs-4">
        <div class="control-group">
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_spec_for" value="0" <?php if($eligibility[0]->area==0) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_spec_for" value="1" <?php if($eligibility[0]->area==1) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_spec_for" value="2" <?php if($eligibility[0]->area==2) echo 'checked'?>/>
    ...
    <div class="col-xs-4">
        <div class="control-group">
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_gender" value="0" <?php if($eligibility[0]->gender==0) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_gender" value="1" <?php if($eligibility[0]->gender==1) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_gender" value="2" <?php if($eligibility[0]->gender==2) echo 'checked'?>/>
                    <span class="lbl"> All</span>
                </label>
            </div>
        </div>
    ...
    <div class="col-xs-4">
        <div class="control-group">
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_poverty" value="0" <?php if($eligibility[0]->poverty_level==0) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_poverty" value="1" <?php if($eligibility[0]->poverty_level==1) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_poverty" value="2" <?php if($eligibility[0]->poverty_level==2) echo 'checked'?>/>
                    <span class="lbl"> All</span>
                </label>
            </div>
        </div>
...
<div class="step-pane" id="step3">
    <div class="col-xs-4">
        <div class="control-group">
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_marital" value="0" <?php if($eligibility[0]->marital_status==0) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_marital" value="1" <?php if($eligibility[0]->marital_status==1) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input  type="radio" class="ace" name="scheme_marital" value="2" <?php if($eligibility[0]->marital_status==2) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_marital" value="3" <?php if($eligibility[0]->marital_status==3) echo 'checked'?>/>
                    <span class="lbl"> All</span>
                </label>
            </div>
        </div>
    ...
    <div class="col-xs-4">
        <div class="control-group">
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_age" value="0" <?php if($eligibility[0]->age==0) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_age" value="1" <?php if($eligibility[0]->age==1) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_age" value="2" <?php if($eligibility[0]->age==2) echo 'checked'?>/>
            ...
            <div class="radio">
                <label>
                    <input type="radio" class="ace" name="scheme_age" value="3" <?php if($eligibility[0]->age==3) echo 'checked'?>/>
                    <span class="lbl"> All</span>
                </label>
            </div>
        </div>
...
<div class="step-pane" id="step4">
    <div class="form-group has-info">
        <label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Why do you want to modify?</label>
        <div class="col-xs-12 col-sm-5">
...
jQuery(function($) {
    ...
    $('#fuelux-wizard')
        ...
        .on('finished', function(e) {
            ...
            $.ajax({
                type    : 'POST',
                url     : '<?php echo base_url();?>policy/modify_data',
                data    : formData,
                dataType : 'json',
                encode: true
            })
